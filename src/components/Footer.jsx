...
const Footer = () => {
  return (
    <div className='w-full h-screen flex px-12 py-10'>
        <div className="left w-1/2 h-full flex justify-between flex-col">
        <div className=''>
        <h1  className='text-[8.5vw] font-["Founders_Grotesk_X"] leading-none uppercase font-medium'>eye-</h1>
        <h1  className='text-[8.5vw] font-["Founders_Grotesk_X"] leading-[0.6] uppercase font-medium'>opening</h1>
        </div>
        <div>
        ...
        <div className="right w-1/2 h-fullflex justify-between flex-col">
        <div className=''>
        <h1  className='text-[8.5vw] font-["Founders_Grotesk_X"] leading-none uppercase font-medium'>presentations</h1>
  ...
  {["Instagram","Behance" ,"Facebook","Linkedin"].map((item,index)=>{
    return <a key={index} className='' href="">{item}</a>
          ...
          <div className='w-36 flex flex-col justify-end gap-5 mt-10'>
        <h1>L:</h1>
  ...
  {["hello@ochi.design"].map((item,index)=>{
    return <a key={index} className='' href="">{item}</a>
        ...
        <h1 className='opacity-70 mt-8 text-base'>© ochi design 2024. Legal Terms</h1>
          </div>
          <div className='inner'>
          <div className='w-36 flex flex-col justify-end gap-5 mt-48'>
        <h1>M:</h1>
  <div className='flex flex-col gap-1'>
  {["home","services","our work","about us","insights","contact us"].map((item,index)=>{
    return <a key={index} className='' href="">{item}</a>
        ...
        <h1 className='opacity-70 mt-[6.8vw] text-base'>Website by Obys</h1>
          </div>
        </div>
        </div>
        </div>
